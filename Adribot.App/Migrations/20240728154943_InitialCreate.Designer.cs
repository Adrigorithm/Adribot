...
namespace Adribot.Migrations
{
    ...
    [Migration("20240728154943_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adribot.src.entities.discord.DGuild", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.discord.DMember", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.discord.Infraction", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.utilities.Event", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.utilities.IcsCalendar", b =>
                {
                    b.Property<int>("IcsCalendarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Adribot.src.entities.utilities.Reminder", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.utilities.Tag", b =>
                {
            ...
            modelBuilder.Entity("Adribot.src.entities.discord.DMember", b =>
                {
                    b.HasOne("Adribot.src.entities.discord.DGuild", "DGuild")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Adribot.src.entities.discord.Infraction", b =>
                {
                    b.HasOne("Adribot.src.entities.discord.DMember", "DMember")
            ...
            modelBuilder.Entity("Adribot.src.entities.utilities.Event", b =>
                {
                    b.HasOne("Adribot.src.entities.utilities.IcsCalendar", "IcsCalendar")
                        .WithMany("Events")
